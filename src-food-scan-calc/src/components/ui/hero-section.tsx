  ...
  (
    {
      ...
      ctaHref = "#",
      bottomImage = {
        light: "https://placehold.co/1200x800/4CAF50/FFFFFF/png?text=Food+Tracking+Dashboard",
        dark: "https://placehold.co/1200x800/2a6c2d/FFFFFF/png?text=Food+Tracking+Dashboard",
      },
      gridOptions,
      ...props
    },
    ...
    return (
      <div className={cn("relative", className)} ref={ref} {...props}>
        <div className="absolute top-0 z-[0] h-screen w-screen bg-primary-100/10 dark:bg-primary-700/10 bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,198,120,0.15),rgba(255,255,255,0))] dark:bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,198,120,0.3),rgba(255,255,255,0))]" />
          ...
          <div className="max-w-screen-xl z-10 mx-auto px-4 py-28 gap-12 md:px-8">
            <div className="space-y-5 max-w-3xl leading-0 lg:leading-5 mx-auto text-center">
              ...
              <h2 className="text-4xl tracking-tighter font-bold bg-clip-text text-transparent mx-auto md:text-6xl bg-[linear-gradient(180deg,_#000_0%,_rgba(0,_0,_0,_0.75)_100%)] dark:bg-[linear-gradient(180deg,_#FFF_0%,_rgba(255,_255,_255,_0.00)_202.08%)]">
                {subtitle.regular}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-primary-400 dark:from-primary-300 dark:to-primary-200">
                  {subtitle.gradient}
                </span>
              </h2>
            ...
            {bottomImage && (
              <div className="mt-32 mx-10 relative z-10">
                <img
                  ...
                  alt="Food tracking nutrition dashboard graphic"
                />
                <img
